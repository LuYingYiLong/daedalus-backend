...
export type ClientCapabilities = Partial<Record<
	"editorTools" | "editorUndoRedo" | "sceneViewCapture" | "inlineDiffUndo" | "inlineDiffView" | "sessionSubscribe" | "approval" | "externalMcp" | "browserTools" | "computerObservation" | "scheduledTasks" | "scheduledTaskReport" | "remoteControl",
	boolean
>>;
