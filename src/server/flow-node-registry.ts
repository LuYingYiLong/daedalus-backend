...
registerBuiltin("text-to-video", "media-generation", "Text to Video", { provider: "", model: "", prompt: "", negativePrompt: "", width: 1280, height: 720, durationMs: 5_000, fps: 24, count: 1, outputFormat: "mp4" }, [fixed("provider", "Provider"), fixed("model", "Model"), hybrid("prompt", "Prompt", "prompt", ["text"], true, true), hybrid("negativePrompt", "Negative prompt", "negativePrompt", ["text"]), hybrid("width", "Width", "width", ["number"]), hybrid("height", "Height", "height", ["number"]), hybrid("durationMs", "Duration", "durationMs", ["number"]), hybrid("fps", "Frame rate", "fps", ["number"]), hybrid("seed", "Seed", "seed", ["number"], false), hybrid("count", "Count", "count", ["number"]), fixed("outputFormat", "Output format")], [output("video", "Video", ["video"], true)], flowDocumentNodeConfigSchemas["builtin/text-to-video"], { modelCapability: "textToVideo", summaryFields: ["provider", "model"], fieldControls: { provider: "provider", model: "model" }, fieldUnits: { width: "px", height: "px", durationMs: "ms", fps: "fps" } });
registerBuiltin("image-to-video", "media-generation", "Image to Video", { provider: "", model: "", prompt: "", negativePrompt: "", width: 1280, height: 720, durationMs: 5_000, fps: 24, count: 1, outputFormat: "mp4" }, [connection("image", "Image", ["image"], true, true), fixed("provider", "Provider"), fixed("model", "Model"), hybrid("prompt", "Prompt", "prompt", ["text"], false, true), hybrid("negativePrompt", "Negative prompt", "negativePrompt", ["text"]), hybrid("width", "Width", "width", ["number"]), hybrid("height", "Height", "height", ["number"]), hybrid("durationMs", "Duration", "durationMs", ["number"]), hybrid("fps", "Frame rate", "fps", ["number"]), hybrid("seed", "Seed", "seed", ["number"], false), hybrid("count", "Count", "count", ["number"]), fixed("outputFormat", "Output format")], [output("video", "Video", ["video"], true)], flowDocumentNodeConfigSchemas["builtin/image-to-video"], { modelCapability: "imageToVideo", summaryFields: ["provider", "model"], fieldControls: { provider: "provider", model: "model" }, fieldUnits: { width: "px", height: "px", durationMs: "ms", fps: "fps" } });
