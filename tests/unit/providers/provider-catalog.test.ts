...
test("provider catalog exposes valid built-in providers and model references", (): void => {
	...
	assert.equal(getProviderDefaultModel("dashscope"), "qwen3.8-max");
	...
	assert.equal(dashscopeModels.find((model) => model.id === "qwen3.8-max")?.maxOutputTokens, 65_536);
	assert.equal(dashscopeModels.find((model) => model.id === "qwen3.8-max")?.capabilities.imageInput, true);
	assert.equal(dashscopeModels.find((model) => model.id === "qwen3.8-max")?.capabilities.videoInput, true);
	...
	assert.equal(dashscopeModels.find((model) => model.id === "qwen3.7-plus")?.capabilities.videoInput, true);
	assert.equal(dashscopeModels.find((model) => model.id === "qwen3.7-flash")?.capabilities.imageInput, true);
	assert.equal(dashscopeModels.find((model) => model.id === "qwen3.7-flash")?.capabilities.videoInput, true);
	assert.equal(dashscopeModels.find((model) => model.id === "qwen3.6-plus")?.capabilities.tools, true);
	assert.equal(dashscopeModels.find((model) => model.id === "qwen3.5-flash")?.capabilities.vision, true);
	assert.equal(dashscopeModels.find((model) => model.id === "qwen-image-3.0-pro")?.capabilities.imageGeneration, true);
	assert.equal(dashscopeModels.find((model) => model.id === "qwen-image-3.0-pro")?.capabilities.imageEdit, true);
	...
	assert.equal(dashscopeModels.find((model) => model.id === "wan3.0-video")?.capabilities.videoGeneration, true);
	assert.equal(dashscopeModels.find((model) => model.id === "wan3.0-video")?.capabilities.videoEdit, true);
	assert.equal(dashscopeModels.find((model) => model.id === "wan3.0-video")?.capabilities.textToVideo, true);
	assert.equal(dashscopeModels.find((model) => model.id === "wan3.0-video")?.capabilities.imageToVideo, true);
	assert.equal(dashscopeModels.find((model) => model.id === "wan3.0-video")?.capabilities.referenceToVideo, true);
	assert.equal(dashscopeModels.find((model) => model.id === "wan3.0-video")?.capabilities.imageInput, true);
	assert.equal(dashscopeModels.find((model) => model.id === "wan3.0-video")?.capabilities.videoInput, true);
	assert.equal(dashscopeModels.find((model) => model.id === "wan2.7-t2v")?.capabilities.videoGeneration, true);
	assert.equal(dashscopeModels.find((model) => model.id === "wan2.7-t2v")?.capabilities.textToVideo, true);
	assert.equal(dashscopeModels.find((model) => model.id === "wan2.7-t2v")?.capabilities.imageInput, undefined);
	assert.equal(dashscopeModels.find((model) => model.id === "wan2.7-i2v")?.capabilities.videoGeneration, true);
	assert.equal(dashscopeModels.find((model) => model.id === "wan2.7-i2v")?.capabilities.imageInput, true);
	assert.equal(dashscopeModels.find((model) => model.id === "wan2.7-i2v")?.capabilities.imageToVideo, true);
	assert.equal(dashscopeModels.find((model) => model.id === "wan2.7-r2v-2026-06-12")?.capabilities.videoInput, true);
	assert.equal(dashscopeModels.find((model) => model.id === "wan2.7-r2v-2026-06-12")?.capabilities.referenceToVideo, true);
	assert.equal(dashscopeModels.find((model) => model.id === "wan2.7-videoedit")?.capabilities.videoEdit, true);
	...
	assert.equal(getProviderDefaultModel("mimo"), "mimo-v2.6-pro");
	...
	assert.equal(mimoModels.length, 3);
	assert.equal(mimoModels.find((model) => model.id === "mimo-v2.5-pro"), undefined);
	assert.equal(mimoModels.find((model) => model.id === "mimo-v2.5"), undefined);
	assert.equal(mimoModels.find((model) => model.id === "mimo-v2.6-pro")?.capabilities.webSearch, true);
	assert.equal(mimoModels.find((model) => model.id === "mimo-v2.6-pro")?.capabilities.imageInput, true);
	assert.equal(mimoModels.find((model) => model.id === "mimo-v2.6-pro")?.capabilities.videoInput, true);
	assert.equal(mimoModels.find((model) => model.id === "mimo-v2.6-flash")?.capabilities.imageInput, true);
	assert.equal(mimoModels.find((model) => model.id === "mimo-v2.6-pro-ultraspeed")?.capabilities.reasoning, true);
	const openaiModels = getProviderFallbackModels("openai");
	assert.equal(getProviderDefaultModel("openai"), "gpt-6-astra");
	assert.equal(openaiModels.find((model) => model.id === "gpt-6-astra")?.contextWindowTokens, 1_050_000);
...
test("provider model list fallback returns normalized capabilities", async (): Promise<void> => {
	...
	assert.equal(result.models.find((item) => item.id === "gpt-image-2.5-sunburst")?.capabilities.imageGeneration, true);
	...
	assert.equal(dashscopeResult.models.find((item) => item.id === "qwen-image-3.0")?.capabilities.imageGeneration, true);
	...
	assert.equal(dashscopeResult.models.find((item) => item.id === "wan3.0-video")?.capabilities.videoGeneration, true);
	assert.equal(dashscopeResult.models.find((item) => item.id === "wan2.7-i2v")?.capabilities.imageInput, true);
	...
	assert.deepEqual(mimoResult.models.map((item) => item.id), ["mimo-v2.6-pro", "mimo-v2.6-flash", "mimo-v2.6-pro-ultraspeed"]);
