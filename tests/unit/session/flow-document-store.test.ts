...
test("Flow node registry exposes strict defaults and all mature node types", (): void => {
	...
	assert.deepEqual(definitions.map((definition): string => definition.typeId), ["builtin/command", "builtin/condition", "builtin/file-input", "builtin/flow-input", "builtin/image-to-image", "builtin/image-to-video", "builtin/json-extract", "builtin/llm", "builtin/media-output", "builtin/merge", "builtin/note", "builtin/output", "builtin/system-prompt", "builtin/template", "builtin/text", "builtin/text-to-image", "builtin/text-to-video", "builtin/tool", "builtin/user-prompt"]);
