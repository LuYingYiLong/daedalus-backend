...
export const BUILTIN_TOOL_MAPPINGS: Record<string, ToolMapping> = {
	...
	"mcp_browser_connect": { serverId: "studio_browser", toolName: "connect" },
	"mcp_browser_propose": { serverId: "studio_browser", toolName: "propose" },
	"mcp_browser_execute_step": { serverId: "studio_browser", toolName: "execute_step" },
	...
	"mcp_plugin_dev_prepare": { serverId: "plugin_development", toolName: "prepare" },
	"mcp_plugin_dev_apply": { serverId: "plugin_development", toolName: "apply" },
	"mcp_plugin_dev_validate": { serverId: "plugin_development", toolName: "validate" },
	"mcp_plugin_dev_install": { serverId: "plugin_development", toolName: "install" },
	"mcp_plugin_dev_test": { serverId: "plugin_development", toolName: "test" },
	...
	"mcp_workspace_list_source_folders": { serverId: "workspace", toolName: "list_source_folders" },
	...
	"mcp_godot_runtime_assert": { serverId: "godot_runtime", toolName: "assert" },
	"mcp_godot_runtime_screenshot": { serverId: "godot_runtime", toolName: "screenshot" },
