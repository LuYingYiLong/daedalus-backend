...
export const REQUEST_HANDLER_METHODS: readonly ClientRequest["method"][] = [
	...
	"godot.runtimeTest.start.result",
...
export const REQUEST_HANDLERS: ReadonlyMap<ClientRequest["method"], RequestHandler> = new Map([
	...
	["browser.external.update", handleClientRequest],
	["session.browserActivity.get", handleClientRequest],
	...
	["flow.tree.order.get", handleConversationFlowRequest],
	["flow.tree.order.update", handleConversationFlowRequest],
	["flow.workspace.move", handleConversationFlowRequest],
	...
	["flow.tools.list", handleConversationFlowRequest],
	["flow.approval.list", handleConversationFlowRequest],
	["flow.approval.resolve", handleConversationFlowRequest],
	["flow.run.preflight", handleConversationFlowRequest],
	["flow.run.start", handleConversationFlowRequest],
	["flow.run.stop", handleConversationFlowRequest],
	["flow.run.retry", handleConversationFlowRequest],
	["flow.run.get", handleConversationFlowRequest],
	["flow.run.report", handleConversationFlowRequest],
	["flow.run.list", handleConversationFlowRequest],
	["flow.artifact.usage", handleConversationFlowRequest],
	["flow.artifact.health", handleConversationFlowRequest],
	["flow.artifact.list", handleConversationFlowRequest],
	["flow.artifact.import", handleConversationFlowRequest],
	["flow.artifact.get", handleConversationFlowRequest],
	["flow.artifact.preview", handleConversationFlowRequest],
	["flow.artifact.thumbnail", handleConversationFlowRequest],
	["flow.artifact.download", handleConversationFlowRequest],
	["flow.artifact.export", handleConversationFlowRequest],
	["flow.artifact.delete", handleConversationFlowRequest],
	["flow.artifact.cleanup", handleConversationFlowRequest],
	["flow.import.fromSession", handleConversationFlowRequest],
	["flow.import", handleConversationFlowRequest],
	["flow.export", handleConversationFlowRequest],
	["flow.transfer.cancel", handleConversationFlowRequest],
	["flow.export.toSession", handleConversationFlowRequest],
	...
	["godot.runtimeTest.start.result", handleGodotRuntimeRequest],
